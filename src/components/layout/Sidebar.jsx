...
import { FaPlus, FaUsers, FaShoppingCart, FaBox } from "react-icons/fa";
...
export default function Sidebar() {
  return (
    <div className="w-64 bg-white min-h-screen shadow-md flex flex-col justify-between">
      ...
      <div className="p-4">
        <div className="bg-green-500 text-white p-4 rounded-xl flex items-center justify-between gap-4">
          <div>
            <p className="text-sm mb-2">
              Please organize your menus through button below!
            </p>
            <div className="flex items-center gap-2 rounded-full bg-white px-3 py-1 text-green-600">
              <FaPlus />
              <span>Add Menus</span>
            </div>
          </div>
